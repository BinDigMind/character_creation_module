...
def defence(char_name: str, char_class: str) -> str:
    ...
    if char_class == 'mage':
        return str(f'{char_name} блокировал {10 + randint(-2, 2)} ед. урона')
    if char_class == 'healer':
        return str(f'{char_name} блокировал {10 + randint(2, 5)} ед. урона')
...
def special(char_name: str, char_class: str) -> str:
    ...
    if char_class == 'mage':
        return str(f'{char_name} применил специальное умение «Атака {5 + 40}»')
    if char_class == 'healer':
